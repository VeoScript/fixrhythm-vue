<template>
  <perfect-scrollbar>
    <div class="p-10 xs:hidden sm:hidden md:hidden lg:w-64 flex flex-col text-white border-r-2 border-red-500 bg-gray-900">
      <div class="flex items-center justify-center">
        <div class="block">
          ...
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-32 rounded-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-4 fill-current text-white" viewBox="0 0 24 24">
              ...
              <span class="text-white text-lg font-bold">Home</span>
            </div>
          </nuxt-link>
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-full rounded-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-4 fill-current text-white" viewBox="0 0 24 24">
              ...
              <span class="text-white text-lg font-bold">Notifications</span>
            </div>
          </nuxt-link>
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-32 rounded-3xl">
              ...
              <span class="text-white text-lg font-bold">Songs</span>
            </div>
          </nuxt-link>
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-36 rounded-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-4 fill-current text-white" viewBox="0 0 24 24">
              ...
              <span class="text-white text-lg font-bold">Poems</span>
            </div>
          </nuxt-link>
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-32 rounded-3xl">
              ...
              <span class="text-white text-lg font-bold">Profile</span>
            </div>
          </nuxt-link>
          <nuxt-link to="/">
            <div class="flex hover:bg-gray-800 p-3 mb-2 w-36 rounded-3xl">
